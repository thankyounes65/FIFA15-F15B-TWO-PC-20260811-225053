# FIFA15 Player B Working-Server QoS Probe v8
...
**Player A build:** `build_pairing_working_server_qos_probe_v8.rs`, parent `build_pairing_working_server_lobby_entry_v4.rs`

**Candidate/package:** `FIFA15-MM-WORKING-SERVER-QOS-PROBE-V8` / `F15B-MM-WORKING-SERVER-SETUP-BURST-V3`, peer gate TCP 48216.
