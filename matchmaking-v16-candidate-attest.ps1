...
$PackageAttestation = 'F15B-GITHUB-DIAGNOSTIC-20260815-V16-NATIVE-HANDOFF-2'
$PackageRevision = 'ea-readiness-v1+loopback-forwarder-17502-17503+matchmaking-v16-native-handoff-diagnostic2'
