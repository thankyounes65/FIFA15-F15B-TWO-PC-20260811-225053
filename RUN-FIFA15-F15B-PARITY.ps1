...
if ($SelfTest) {
    ...
    Write-Host "PASS: Player B QoS-pacing-preauth v12 runner pins $ExpectedBranch / $Candidate / $Package, attaches nothing to fifa15.exe, retains the known-good boot/connect stack, and RUN-FIFA15-F15B.bat's own banner names the current candidate." -ForegroundColor Green
    exit 0
}
